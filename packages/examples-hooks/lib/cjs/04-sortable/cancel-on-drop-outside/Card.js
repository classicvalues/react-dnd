...
var Card = function (_a) {
    var id = _a.id, text = _a.text, moveCard = _a.moveCard, findCard = _a.findCard;
    var originalIndex = findCard(id).index;
    var _b = useDrag({
        item: { type: ItemTypes_1.default.CARD, id: id, originalIndex: originalIndex },
    ...
    var _c = useDrop({
        ...
        hover: function (_a) {
            var draggedId = _a.id;
            if (draggedId !== id) {
                var overIndex = findCard(id).index;
                moveCard(draggedId, overIndex);
            }
        },
    }), drop = _c[1];
    var opacity = isDragging ? 0 : 1;
    return (react_1.default.createElement("div", { ref: function (node) { return drag(drop(node)); }, style: __assign({}, style, { opacity: opacity }) }, text));
};
