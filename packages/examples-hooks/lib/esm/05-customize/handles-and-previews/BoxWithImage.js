...
const BoxWithImage = () => {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(DragPreviewImage, { connect: preview, src: boxImage }),
        React.createElement("div", { ref: drag, style: Object.assign({}, style, { opacity }) }, "Drag me to see an image")));
};
