...
const Container = () => {
    ...
    return (React.createElement("div", null,
        React.createElement("div", { style: { overflow: 'hidden', clear: 'both' } }, dustbins.map(({ accepts, lastDroppedItem }, index) => (React.createElement(Dustbin, { accept: accepts, lastDroppedItem: lastDroppedItem, 
