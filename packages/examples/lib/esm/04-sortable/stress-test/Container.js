...
export default class Container extends React.Component {
    ...
    render() {
        ...
        return (React.createElement("div", { style: style }, cardsByIndex.map(card => (React.createElement(Card, { key: card.id, id: card.id, text: card.text, moveCard: this.moveCard })))));
    }
